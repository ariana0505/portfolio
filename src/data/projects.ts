...
export const projects: Project[] = [
  {
    ...
    description: {
      en: 'Solutions to the curated LeetCode 75 problem list in Python. Covering arrays, trees, dynamic programming, and more. Currently 38 of 75 problems solved.',
      es: 'Soluciones a la lista curada de 75 problemas de LeetCode en Python. Abarcando arreglos, árboles, programación dinámica y más. Actualmente 38 de 75 problemas resueltos.',
    },
